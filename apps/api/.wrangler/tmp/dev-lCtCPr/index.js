...
// .wrangler/tmp/bundle-tQ9fCp/strip-cf-connecting-ip-header.js
...
// ../../node_modules/.pnpm/@hono+trpc-server@0.4.0_@tr_dd74b6651fabe4cc3726e16c3ab8e7ad/node_modules/@hono/trpc-server/dist/index.js
...
var appRouter = router({
  ...
  createUser: publicProcedure.input(external_exports.object({ name: external_exports.string() })).mutation(({ input }) => {
    return {
...
var envSchema = external_exports.object({
   ...
   */
  NASA_EARTHDATA_TOKEN: external_exports.string().min(1, "NASA_EARTHDATA_TOKEN is required"),
  /**
   * AirNow API Key
   * Required for ground-based air quality validation data (EPA)
   * Get it from: https://docs.airnowapi.org/account/request/
   */
  AIRNOW_API_KEY: external_exports.string().min(1, "AIRNOW_API_KEY is required"),
  /**
   ...
   */
  FIRMS_API_KEY: external_exports.string().min(1, "FIRMS_API_KEY is required")
});
...
// ../../node_modules/.pnpm/wrangler@3.114.14_@cloudflare+workers-types@4.20251004.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@3.114.14_@cloudflare+workers-types@4.20251004.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-tQ9fCp/middleware-insertion-facade.js
...
// ../../node_modules/.pnpm/wrangler@3.114.14_@cloudflare+workers-types@4.20251004.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-tQ9fCp/middleware-loader.entry.ts
